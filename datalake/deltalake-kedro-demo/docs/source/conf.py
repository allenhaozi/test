...
# deltalake_kedro_demo documentation build
...
from deltalake_kedro_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "deltalake_kedro_demo"
author = "Kedro"
...
htmlhelp_basename = "deltalake_kedro_demodoc"
...
latex_documents = [
    (
        master_doc,
        "deltalake_kedro_demo.tex",
        "deltalake_kedro_demo Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "deltalake_kedro_demo",
        "Project deltalake_kedro_demo codebase.",
        "Data-Science",
    )
]
