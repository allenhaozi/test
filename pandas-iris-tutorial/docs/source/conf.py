...
# pandas_iris_tutorial documentation build
...
from pandas_iris_tutorial import __version__ as release

# -- Project information -----------------------------------------------------

project = "pandas_iris_tutorial"
author = "Kedro"
...
htmlhelp_basename = "pandas_iris_tutorialdoc"
...
latex_documents = [
    (
        master_doc,
        "pandas_iris_tutorial.tex",
        "pandas_iris_tutorial Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pandas_iris_tutorial",
        "Project pandas_iris_tutorial codebase.",
        "Nearest-Neighbour",
    )
]
